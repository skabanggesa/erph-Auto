...
// Guna nama yang sesuai seperti dalam jadual guru (contoh: "Bahasa Melayu" → "bm")
...
window.getTemplateUrl = (subjectDisplayName) => {
...
// Eksport untuk modular JS (jika diperlukan)
export { app, auth, db };
